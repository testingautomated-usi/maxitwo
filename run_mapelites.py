...
parser.add_argument(
    "--iteration-runtime", help="Search budget of the algorithm (in number of iterations)", type=int, default=60
)
...
parser.add_argument(
    "--cyclegan-epoch", type=str, default=-1, help="which epoch to load? set to latest to use latest cached model"
)
