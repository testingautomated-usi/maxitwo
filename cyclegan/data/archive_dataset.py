...
class ArchiveDataset(BaseDataset):
    ...
    def __init__(self, opt):
        ...
        assert os.path.exists(
            opt.archive_filepath
        ), "archive_filepath {} does not exist".format(opt.archive_filepath)
        ...
        for sim_name in SIMULATOR_NAMES:
            if sim_name in archive_name:
                ...
                break
        assert self.env_name is not None, "Env name {} not found in {}".format(
            SIMULATOR_NAMES, archive_name
        )
