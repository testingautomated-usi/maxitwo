...
from config import SIMULATOR_NAMES, BEAMNG_SIM_NAME, DONKEY_SIM_NAME, AGENT_TYPES, UDACITY_SIM_NAME, INPUT_SHAPE, \
    NUM_CONTROL_NODES, MAX_ANGLE, NUM_SAMPLED_POINTS, MOCK_SIM_NAME
...
def make_env(
    ...
    assert simulator_name in SIMULATOR_NAMES, 'Unknown simulator name {}. Choose among {}'.format(simulator_name, SIMULATOR_NAMES)
